...
> [!NOTE]
> Due to 2 main scripts often not handling exit correctly, a new script was introduced in v1.1.0 - `basic-tail.sh`, which simply `tail`s the latest log _with_ color and _without_ any GD dependencies. It's recommended to use it instead of main scripts in case you're running into inotify limits
